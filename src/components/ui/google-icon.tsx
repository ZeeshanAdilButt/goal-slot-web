/**
 * Google's official multi-color "G" mark, used on the "Continue with Google"
 * buttons on the login and signup pages. Shared here so both pages render
 * the identical icon instead of duplicating the inline SVG.
 */
