...
export function TasksView({
  ...
  const filteredTasks = useMemo(() => {
    return tasks.filter((task) => {
      ...
      if (durationFilter !== 'all') {
        ...
        } else if (durationFilter === 'short') { // < 30m
  ...
  }, [tasks, dueDateFilter, durationFilter, searchQuery, customDateStart, customDateEnd, customDurationMin, customDurationMax])
                      ...
                      <div className="flex items-center gap-2 overflow-hidden">
                        ...
                        <span className="truncate">
                          {dueDateFilter === 'all' ? 'Any Date' : 
                           dueDateFilter === 'custom' ? 'Custom' :
                           dueDateFilter === 'week' ? 'This Week' :
                           dueDateFilter === 'next_week' ? 'Next Week' :
                  ...
                  <PopoverTrigger asChild>
                    <button className="flex h-8 w-[140px] items-center justify-between rounded-sm border-2 border-secondary bg-white px-3 text-[10px] font-bold uppercase shadow-brutal-sm outline-none ring-offset-background focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                      <div className="flex items-center gap-2 overflow-hidden">
                        ...
                        <span className="truncate">
                          {durationFilter === 'all' ? 'Any Duration' : 
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="border-t border-gray-200 pt-3">
                        ...
                        <p className="mt-1 text-[10px] text-gray-400">
                          Common: 15, 30, 60, 90, 120 minutes
                        </p>
                      </div>
                    </div>
                  </PopoverContent>
